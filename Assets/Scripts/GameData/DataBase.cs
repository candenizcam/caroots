    ...
    public static class DataBase
    {
        ...
        public static LevelRecord[] LevelRecordsArray = new  LevelRecord[] 
        {
            ...
            new("worm",new[] {
                ...
                ,"Bir daha hiçbir yağmur hiçbir kardeşi ayıramasın,\nkimsenin solu-canı yanmasın efendim."),
            new("cater",new[] {
                    "karahalka","ogulcan","sümbül","cabbar",
                    "diken","altintekme","saban","ramazan",
                    "abuzer","recep","tosun","nisa"},
                ...
                "Çok farklı hayatlar yaşıyor da olsak da önemli olan hala\nbir araya gelebilmek; hala değer verebilmek bence."),
            new("turtle",new[] {
                    "karahalka","ogulcan","sümbül","cabbar",
                    "diken","altintekme","saban","ramazan",
                    "abuzer","recep","tosun","nisa"},
               ...
               "İlla kan bağına ihtiyaç yok, sevgiyle kurulan\naile bağlarını ninja yıldızları bile koparamaz."),
            new("rooster",new[] {
                    "karahalka","ogulcan","sümbül","cabbar",
                    "diken","altintekme","saban","ramazan",
                    "abuzer","recep","tosun","nisa"},
                ...
                "Ayrılık gelse de başa geldikleri yerleri\nunutmayanlar dönüş yolunu da daima hatırlarlar.")
        ...
        {"Kimse gelmedi ama, biz bir tekrar deneyelim.","Kimse gelmedi ama, hemen vazgeçmeye gerek yok.","Kimse gelmedi ama, umudumuzu kaybetmemek lazım.","Kimse gelmedi ama, bence hala şansımız var."
        };
    }
}